          ...
          <p class="pull-right visible-xs">
            <button type="button" class="btn btn-primary btn-xs" data-toggle="offcanvas">Toggle nav</button>
                    ...
                    <thead>
                     ...
                     <tbody>
                     <?php foreach ($tablacomision as $key){ ?>
                    <tr>
                        <td class="text-center"><?php echo $key['razonSocial']; ?></td>
                        <td class="text-center"><?php echo $key['fechaRegistro']; ?></td>
                        <td class="text-center"><?php echo $key['fechaActualizacion']; ?></td>
                        <td class="text-center"><!--<a href="#" id="new" data-idEmpresa="<?php //echo $key['idEmpresa'];?>" data-nombreEmpresa="<?php //echo $key["razonSocial"];?>"><!--<i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;-->

                        <a href="../gridUnidadNegocio/<?php echo $key['idEmpresa'];?>/<?echo $idEsquema?>"><i class="fa fa-universal-access" aria-hidden="true"></i></a> &nbsp;&nbsp;
                        </td>
                    </tr>
                     <?php } ?>
                </table>
